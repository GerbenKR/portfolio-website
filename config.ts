...
export const projects: ProjectItem[] = [
    ...
    },
    {
        ...
        description: 'Een single page website waar je kan zien hoevaak er op een track is gestemd tijdens het Foute Uur.',
    ...
    },
    {
        ...
        description: 'Omrekenen is een website waarop je heel makkelijk alle eenhenden kan omrekenen.',
        image: 'https://i.gerbenkr.nl/images/2s7lw36k247a.png',
        url: 'https://omrekenen.gerbenkr.nl',
        source: null,
    },
    {
        title: 'Kevins Chatbox Discord Bot',
        slug: 'kevins-chatbox',
    ...
    {
        title: "Erik-Jan's Weerbericht",
        slug: 'erik-jan-weerbericht',
        technologies: 'HTML, CSS, JavaScript (VueJS)',
        description: 'Een website waar Erik-Jan Rosendahl het weer bericht voor zijn radio shows kon oplezen.',
        image: 'https://i.gerbenkr.nl/images/u9kly114zzb5.png',
        url: null,
        source: null,
    },
];
